...
const REGULATED_HUBS: HubLocation[] = [
  {
    ...
    address: '25 Canada Square, Canary Wharf / 25 Old Broad St, London, EC2N 1HN, UK',
    ...
    email: 'london.desk@growvest.com',
    latency: '11ms',
    colorBorder: 'border-emerald-500/40'
  },
  {
    id: 'europe',
    city: 'Europe (Frankfurt)',
    region: 'Germany / EU',
    ...
    email: 'frankfurt.desk@growvest.com',
    latency: '14ms',
  ...
  },
  {
    ...
    address: 'Gotthardstrasse 26, 8002 Zurich Financial District, Switzerland',
    ...
    email: 'zurich.vault@growvest.com',
    latency: '16ms',
